# PostFinanceCheckout Ruby SDK

- API version: 2.0

The PostFinanceCheckout Ruby SDK is used to interact with PostFinanceCheckout's REST API.
...
When working with webhooks, the `PostfinancecheckoutRubySdk::PostFinanceCheckoutSdkException` may throw error codes to help with debugging.
