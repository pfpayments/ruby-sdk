...
SPACE_ID = '72979'
TEST_USER_ID = '123441'
TEST_AUTHENTICATION_KEY = 'oWVGn42ks+yIbuHt8w09kyQRUEgIuYxqd/F59LO/lF0='
TEST_CARD_PAYMENT_METHOD_CONFIGURATION_ID = '340868'
TEST_CUSTOMER_ID = '1234'

MOCK_CARD_DATA = PostfinancecheckoutRubySdk::AuthenticatedCardRequest.new(
  card_data: PostfinancecheckoutRubySdk::AuthenticatedCardDataCreate.new(
