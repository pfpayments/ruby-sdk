...
class RefundsServiceTest < Test::Unit::TestCase
  ...
  def test_refund_of_completed_transaction_should_work
    ...
    assert_equal(
      PostfinancecheckoutRubySdk::RefundState::SUCCESSFUL,
      refund.state,
  ...
  def build_refund_create(transaction)
    PostfinancecheckoutRubySdk::RefundCreate.new(
      transaction: transaction.id,
      type: PostfinancecheckoutRubySdk::RefundType::MERCHANT_INITIATED_ONLINE,
